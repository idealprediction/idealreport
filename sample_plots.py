...
bar_plot = {"title": "Vertical Bar Chart (Create HTML)", "data": [{"df": df_bar[["Stat 1", "Stat 2"]], "type": "bar", "orientation": "v"}], "labelX": "Entity", "labelY": "Stat", "staticPlot": False}

# ps: stacked horizontal bar chart (additional data field required: orientation)
stacked_bar_plot = {
    "title": "Horizontal Stacked Bar Chart (Create HTML)",
    "data": [{"df": df_bar[["Value 1", "Value 2"]], "type": "stackedBar", "orientation": "h"}],
    "labelX": "Value",
    "staticPlot": False,
}

# ps: line chart
line_plot = {"title": "Line Plot (Create HTML)", "data": [{"df": df_line, "type": "line"}], "staticPlot": False}

# ps: scatter plot
scatter_plot = {"title": "Scatter Plot (Create HTML)", "data": [{"df": df_line.set_index("a"), "type": "scatter"}], "labelX": "alpha", "labelY": "beta", "staticPlot": False}

# ps: mixed plot types on one graph
multi_scatter_plot = {
    "title": "Mixed Line and Bar Plot (Create HTML)",
    "data": [{"df": df_line["a"], "type": "line"}, {"df": df_line["b"], "type": "bar", "orientation": "v"}],
    "labelX": "x label",
    "labelY": "y label",
    "staticPlot": False,
}
...
multi_axis_plot = {
    ...
    "data": [{"df": df_line["a"], "type": "line"}, {"df": df_line["b"], "type": "line", "y2": True}],
    "labelX": "x",
    "labelY": "y from a",
    "labelY2": "y from b",
}
...
# ps: box plot
box_plot = {"title": "Box Plot (Create HTML)", "data": [{"df": df_line, "orientation": "v"}], "type": "box", "staticPlot": False}
...
r.h += r.plot.pie(df=df_bar, title="Donut (Reporter)", hole=0.4)
...
layout = {
    ...
    "width": 500,
    "height": 500,
    "shapes": [{"type": "line", "xref": "paper", "yref": "paper", "x0": 0, "y0": 0, "x1": 0.5, "y1": 0.5, "line": {"color": "rgb(50, 171, 96)", "width": 3}}],
    "showlegend": False,
}
custom_design = {"layout": layout, "markers": markers}
...
r.h += r.plot.sankey(df=df_sankey, title="Sankey Plot (Reporter)", custom_design={"nodeLabels": ["node_a", "node_b", "node_c", "node_d", "node_e", "node_f"]})
